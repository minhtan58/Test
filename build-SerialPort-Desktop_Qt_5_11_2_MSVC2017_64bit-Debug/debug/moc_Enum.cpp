...
QT_MOC_LITERAL(18, 246, 28), // "HMI_VIEW_DATA_HISTORY_SCREEN"
QT_MOC_LITERAL(19, 275, 16), // "HMI_COMMON_POPUP"
QT_MOC_LITERAL(20, 292, 14), // "HMI_HIDE_POPUP"
QT_MOC_LITERAL(21, 307, 19), // "HMI_CONNECTED_POPUP"
QT_MOC_LITERAL(22, 327, 22), // "HMI_DISCONNECTED_POPUP"
QT_MOC_LITERAL(23, 350, 31), // "HMI_TEST_CONNECTIONS_SERIALPORT"
QT_MOC_LITERAL(24, 382, 24), // "HMI_SEND_DATA_SERIALPORT"
QT_MOC_LITERAL(25, 407, 28), // "HMI_TEST_CONNECTIONS_NETWORK"
QT_MOC_LITERAL(26, 436, 21), // "HMI_SEND_DATA_NETWORK"
QT_MOC_LITERAL(27, 458, 25), // "HMI_UPDATE_TIME_AUTOMATIC"
QT_MOC_LITERAL(28, 484, 17), // "HMI_SET_DATE_TIME"
QT_MOC_LITERAL(29, 502, 19), // "HMI_UPDATE_DATABASE"
QT_MOC_LITERAL(30, 522, 19) // "HMI_REMOVE_DATABASE"
    ...
    "HMI_DATA_VIEW_SCREEN\0HMI_VIEW_DATA_HISTORY_SCREEN\0"
    "HMI_COMMON_POPUP\0HMI_HIDE_POPUP\0"
    "HMI_CONNECTED_POPUP\0HMI_DISCONNECTED_POPUP\0"
    "HMI_TEST_CONNECTIONS_SERIALPORT\0"
    "HMI_SEND_DATA_SERIALPORT\0"
    "HMI_TEST_CONNECTIONS_NETWORK\0"
    "HMI_SEND_DATA_NETWORK\0HMI_UPDATE_TIME_AUTOMATIC\0"
    "HMI_SET_DATE_TIME\0HMI_UPDATE_DATABASE\0"
    "HMI_REMOVE_DATABASE"
};
...
static const uint qt_meta_data_EnumID[] = {
 ...
 // enum data: key, value
      ...
      18, uint(EnumID::HMI_VIEW_DATA_HISTORY_SCREEN),
      19, uint(EnumID::HMI_COMMON_POPUP),
      20, uint(EnumID::HMI_HIDE_POPUP),
      21, uint(EnumID::HMI_CONNECTED_POPUP),
      22, uint(EnumID::HMI_DISCONNECTED_POPUP),
      23, uint(EnumID::HMI_TEST_CONNECTIONS_SERIALPORT),
      24, uint(EnumID::HMI_SEND_DATA_SERIALPORT),
      25, uint(EnumID::HMI_TEST_CONNECTIONS_NETWORK),
      26, uint(EnumID::HMI_SEND_DATA_NETWORK),
      27, uint(EnumID::HMI_UPDATE_TIME_AUTOMATIC),
      28, uint(EnumID::HMI_SET_DATE_TIME),
      29, uint(EnumID::HMI_UPDATE_DATABASE),
      30, uint(EnumID::HMI_REMOVE_DATABASE),
